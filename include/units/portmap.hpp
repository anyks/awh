...
namespace awh {
	...
	namespace unit {
		 ...
		 *   узлу по устройству самой сети: систему такая просьба лишь заставляет ответить
		 *   отказом, а рассылку она доставляет и без подписки. Отличие от рассылки
		 *   обнаружения SSDP, где членство обязательно, именно в этом: там адрес свой,
		 *   договорный.
		 *
