	...
	namespace http {
		...
		typedef class __AWH_SHARED_EXPORT__ Headers {
			...
			public:
				 ...
				 * @return        общее количество заголовков
				 */
				size_t emplace(string_view name, string_view content) noexcept;
				/**
				 * @brief Метод добавления или замены заголовка
				 *
				 * @note Если заголовок с указанным именем уже существует, все его вхождения
				 ...
				 * @return        общее количество заголовков
				 */
				size_t emplace(string && name, const string & content) noexcept;
				/**
				 * @brief Метод добавления или замены заголовка
				 *
				 * @note Если заголовок с указанным именем уже существует, все его вхождения
				 ...
				 * @return        общее количество заголовков
				 */
				size_t emplace(const string & name, string && content) noexcept;
				/**
				 * @brief Метод добавления или замены заголовка
				 *
				 * @note Если заголовок с указанным именем уже существует, все его вхождения
