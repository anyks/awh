		...
		typedef class __AWH_SHARED_EXPORT__ Parser_HTTP2 : public parser_t {
			...
			private:
				...
				typedef struct __AWH_SHARED_EXPORT__ Buffer {
					 ...
					 * функции: дописывать их сразу во входной буфер нельзя - перевыделение
					 * памяти обесценит zero-copy указатели, уже отданные наружу
					 */
					string deferred;
			...
			private:
				 ...
				 *
				 */
				void deferPriority(const uint32_t id, const string_view value) noexcept;
				/**
