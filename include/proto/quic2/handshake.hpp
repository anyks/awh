 ...
 *
 * @brief Заголовочный файл криптографического рукопожатия QUIC — класс quic2::Handshake,
...
#ifndef __AWH_PROTO_QUIC2_HANDSHAKE__
#define __AWH_PROTO_QUIC2_HANDSHAKE__
	...
	namespace quic2 {
		...
		typedef class __AWH_SHARED_EXPORT__ Handshake {
			...
			public:
				 ...
				 *
				 */
				bool params(const quic2::params::params_t & params) noexcept;
				/**
				 ...
				 *
				 */
				status_t peer(quic2::params::params_t & params, error_t & error) const noexcept;
			public:
				/**
...
#endif // __AWH_PROTO_QUIC2_HANDSHAKE__
