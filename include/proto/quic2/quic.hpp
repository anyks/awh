...
#ifndef __AWH_PROTO_QUIC2__
#define __AWH_PROTO_QUIC2__
...
namespace awh {
	...
	namespace quic2 {
		...
		enum class status_t : uint8_t {
			...
			BLOCKED    = 0x03  // Буфер отправки потока полон - повторить постановку позже (backpressure)
		};
