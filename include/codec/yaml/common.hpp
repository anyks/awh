...
namespace awh {
	...
	namespace codec {
		...
		namespace yaml {
			 ...
			 *          лишь таблица сообщений. Таковых ОДИННАДЦАТЬ из пятидесяти четырёх:
			 ...
			 *          OVERFLOW_LIMIT, CONFLICTING_SETTINGS и SETTINGS_ALREADY_APPLIED
			 *
			 ...
			 *
			 * @note Прочие шесть - UNEXPECTED_EOF, INVALID_NUMBER, NUMBER_OUT_OF_RANGE,
			 *       EXPECTED_KEY, EXPECTED_COLON и SETTINGS_ALREADY_APPLIED - причин
			 *       установленных не имеют. Первые пять переехали в перечень вместе с образцом
			 *       кодека JSON, где они объявлены и живы, а к местам выдачи привязаны не были
			 *
