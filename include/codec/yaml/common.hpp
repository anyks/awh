...
namespace awh {
	...
	namespace codec {
		...
		namespace yaml {
			 ...
			 *
			 * @warning Запись гласила «мест выдачи не имеет вовсе… вынесено владельцу
			 ...
			 *          закрывает. Иначе доклад владельцу уходит второй раз по работе,
			 *          уже сделанной
			 *
			 ...
			 *       тогда как довод выше гласит, что правило владельцем положено ОДИНАКОВЫМ для
			 ...
			 *
			 * @note Разведено 08.09.2026 в пользу довода владельца: настройка заведена у TOML и
			 ...
			 *       эти чужие, и расхождение доложено их владельцам
			 */
