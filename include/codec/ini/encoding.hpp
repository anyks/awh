 ...
 *
 * \~english
 * @brief Header file of the conversion of the source text of the settings to the UTF-8 encoding —
...
namespace awh {
	...
	namespace codec {
		...
		namespace ini {
			 ...
			 * @note A settings text, unlike an XML markup, does not announce its encoding:
