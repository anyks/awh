...
namespace awh {
	...
	namespace codec {
		...
		namespace ini {
			 ...
			 *       разбор, какой не сработает никогда. Владельцу доложено отдельным вопросом -
			 *       снести ли их, оживить ли, либо пометить задельными; решение это ЕГО, ибо
			 ...
			 *
			 * @note Обе находки, владельцу доложенные, упёрлись ровно в них: подача каталога
