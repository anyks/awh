		...
		namespace xml {
			...
			typedef class __AWH_SHARED_EXPORT__ Reader {
				...
				private:
					...
					/**
					 * @brief Разобранный атрибут узла до разрешения пространств имён
					 *
					 */
				...
				private:
					// Разобранные атрибуты текущего узла до разрешения пространств имён
