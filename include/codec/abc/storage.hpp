...
namespace awh {
	...
	namespace codec {
		...
		namespace abc {
			 ...
			 * четырёх мест, а к прогону 05.09.2026 таких мест осталось два: кодеки
			 * те правились, и охрана ушла вместе с правками. Охрана, пришедшая
			 * извне, уходит с первой правкой чужого кодека
			 *
