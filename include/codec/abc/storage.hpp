...
namespace awh {
	...
	namespace codec {
		...
		namespace abc {
			 ...
			 *
			 * @warning Сплошной щуп по хранилищу надлежит ПРОВЕСТИ ЗАНОВО: мест отказа стало
			 * меньше, устройство их иное, и всякая цифра прежних сводок недействительна.
			 * До того о покрытии хранилища судить нечем, кроме прогона набора
			 *
