...
namespace awh {
	...
	namespace codec {
		...
		namespace abc {
			 ...
			 * есть заслоны живы и хожены, а недостижимо их УСЛОВИЕ: шифрование и сжатие
			 * отказывают лишь при недостающем снаряжении либо отказе самой подсистемы, а
			 * длина сверх поля кадра требует записи шире четырёх гигабайт. Мёртвым кодом
			 * их звать нельзя: молчание щупа причин означало лишь, что причины там никто не
			 * спрашивает
			 *
