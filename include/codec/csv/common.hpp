	...
	namespace codec {
		...
		namespace csv {
			...
			enum class error_t : uint8_t {
				...
				FILE_NOT_OPENED      = 0x14, // Файл таблицы открыть не удалось
				TEXT_ALREADY_ENDED   = 0x15, // Подача продолжена после объявленного конца текста
				FILE_NOT_WRITTEN     = 0x16  // Текст таблицы записать в файл не удалось
			};
