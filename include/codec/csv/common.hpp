...
namespace awh {
	...
	namespace codec {
		 ...
		 * ВЛАДЕЛЬЦА по нему не было: расхождение вынесено ему 07.09.2026 вместе с `type()`,
		 * `graft()`, `separator` и способом отступа, и ответа пока нет
		 *
		...
		namespace csv {
			...
			enum class error_t : uint8_t {
				 ...
				 *       начертании простого значения; найдено владельцем кодеков INI, TOML и
				 ...
				 *       того, чтобы подать обработчик. Найдено 15.09.2026 по доводу владельца
