...
namespace awh {
	...
	namespace codec {
		...
		namespace csv {
			/**
			 * \~russian
			 * @brief Состояние чтения текста таблицы
			 *
			 ...
			 *
			 * @warning Не путать с `complete()`: тот завершает текущее ПОЛЕ, а не разбор,
			 *          и имя его совпало с общим договором случайно
			 *
			 * \~english
			 * @brief State of the reading of a table text
			 *
			 * \~
			 */
			...
			typedef class __AWH_SHARED_EXPORT__ Reader {
				...
				public:
					 ...
					 * @return current state of the reading of a table text
					 *
					 * \~
					 */
