 ...
 *          произвольной глубины - вложенные повторения, обратные ссылки
 *          и рекурсия, - кодогенерации не получают вовсе и исполняются
 ...
 *          получают. Не требуют их и атомарные группы с проверками окружения -
 *          см. раздел о действующем отказе ниже.
 *
