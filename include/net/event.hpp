...
namespace awh {
	...
	namespace event {
		...
		enum class family_t : uint8_t {
			...
			FSYS  = 0x02, // Файловое семейство событий
			PIPE  = 0x03, // Семейство событий пайпов
			USER  = 0x04, // Пользовательское семейство событий
			IPV4  = 0x05, // Семейство событий IPv4
			IPV6  = 0x06, // Семейство событий IPv6
			UDPV4 = 0x07, // Семейство событий UDPv4
			UDPV6 = 0x08, // Семейство событий UDPv6
			TIMER = 0x09  // Семейство событий таймеров
		};
		/**
		 * @brief Типы сокетов
		 *
