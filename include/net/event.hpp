...
namespace awh {
	...
	namespace event {
		...
		enum class node_t : uint8_t {
			...
			FSYS   = 0x02, // Файловая система
			PEER   = 0x03, // Узел-сосед
			USER   = 0x04, // Пользовательский узел
			TIMER  = 0x05, // Таймерный узел
			CLIENT = 0x06, // Клиентский узел
			SERVER = 0x07  // Серверный узел
		};
		/**
