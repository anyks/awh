 ...
 *
 * @note Заголовка этого у оснастки MSVC нет вовсе - он принадлежит наречиям POSIX и их
 *       подражаниям. Нужен он ради ssize_t и приёмов работы с описателями, а у MSVC те
 *       приходят из <io.h> вместе с самим описателем
 */
#if defined(_MSC_VER)
	#include <io.h>
#else
