	...
	typedef class NTP {
		...
		private:
			...
			typedef struct Packet {
				 ...
				 */
				Packet() noexcept :
				 mode(0), stratum(0), poll(0), precision(0), rootDelay(0),
				 rootDispersion(0), refId(0), refTimeStampSec(0), refTimeStampSecFrac(0),
				 origTimeStampSec(0), origTimeStampSecFrac(0), receivedTimeStampSec(0),
				 receivedTimeStampSecFrac(0), transmitedTimeStampSec(0), transmitedTimeStampSecFrac(0) {}
