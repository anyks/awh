...
namespace awh {
	...
	namespace net {
		 ...
		 *
		 * @note Зоны адреса структура не хранит, а адресам локальной связи она
		 *       нужна: без неё такой адрес неоднозначен. Держать зону приходится
		 *       отдельно - её ведает класс `net_addr_t`
		 *
		 */
		 ...
		 */
			 ...
			 *          части из них
			 *
			 * @note Доступен протокол лишь на Linux и FreeBSD - прочие системы его не
			 *       несут, отчего всё это пространство имён собирается только там
			 *
			 */
			namespace sctp {
				/**
