...
namespace awh {
	...
	typedef class AWH_SHARED_EXPORT Socks5 {
		...
		protected:
			/**
			 * @brief Структура экшена сообщения
			 *
			 */
			typedef struct Action {
				 ...
				 *
				 */
				Action() noexcept : method(0x00), version(0x00) {}
			...
			typedef struct Auth {
				 ...
				 *
				 */
				Auth() noexcept : status(0x00), version(0x00) {}
			...
			typedef struct Request {
				...
				uint8_t version; // Версия прокси-протокола
				/**
				 * @brief Конструктор
				 *
				 */
