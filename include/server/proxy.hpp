		...
		typedef class Proxy {
			public:
				...
				enum class flag_t : uint8_t {
					...
					CONNECT_METHOD_CLIENT_ENABLE = 0x07, // Флаг разрешающий метод CONNECT на прокси-клиенте
					CONNECT_METHOD_SERVER_ENABLE = 0x08  // Флаг разрешающий метод CONNECT на сервере
				};
			private:
				/**
