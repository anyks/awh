 ...
 *
 *          <b>Область отдаётся системе немедленно при освобождении.</b> Держать
 *          свободными куски по многу мегабайт впрок значило бы копить у себя ровно то,
 *          ради чего к нам и приходят с жалобой на расход. Крупных выдач немного, и
 *          цена вызова системы на их фоне теряется.
 *
