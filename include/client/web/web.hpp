		...
		typedef class Web {
			public:
				...
				enum class flag_t : uint8_t {
					...
					PROXY_NOCONNECT  = 0x08, // Флаг отключающий метод CONNECT для прокси-клиента
					TAKEOVER_CLIENT  = 0x09, // Флаг ожидания входящих сообщений для клиента
					TAKEOVER_SERVER  = 0x0A, // Флаг ожидания входящих сообщений для сервера
					WEBSOCKET_ENABLE = 0x0B  // Флаг разрешения использования WebSocket-клиента
				};
			public:
				/**
