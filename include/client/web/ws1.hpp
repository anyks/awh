	...
	namespace client {
		...
		typedef class AWH_SHARED_EXPORT Websocket1 : public web_t {
			...
			private:
				 ...
				 */
				void callbackEvent(const callback_t::event_t event, const uint32_t fid, const callback_t::fn_t &) noexcept;
			private:
				/**
			...
			private:
				 ...
				 */
				void chunking(const uint32_t bid, const awh::buffer_t & chunk, const awh::http_t * http) noexcept;
			private:
				/**
