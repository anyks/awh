...
// Размер минимального заказа в долларах
#define MIN_ORDER 10.0
...
// Интервал времени ожидания на исполнение заказа
#define ORDER_EXPIRED 1800000
// Размер ограничителя в долларах
#define LIMITER_SIZE 20.0
// Окно времени для Binance
#define RECV_WINDOW 60000
