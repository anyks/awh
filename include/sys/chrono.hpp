 ...
 *          zone_t::CT, zone_t::ET, zone_t::MT и zone_t::PT - выбирают стандартное
 *          либо летнее время по самому записываемому моменту, а не по текущему.
 *          Правила прочих стран модуль не отслеживает, и поле dst объекта даты для
 *          зон вне Северной Америки - величина справочная, а не свойство зоны.
 *
