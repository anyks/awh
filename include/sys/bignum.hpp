...
namespace awh {
	...
	namespace bignum {
		 ...
		 *
		 */
		__AWH_SHARED_EXPORT__ string realPrint(const uint8_t * value, const size_t size, const format_t format, const uint8_t precision) noexcept;
		/**
	...
	class __AWH_SHARED_EXPORT__ BigNum {
		...
		public:
			 ...
			 *
			 */
			string print(const format_t format = format_t::DEC, const uint8_t precision = 0) const noexcept;
			/**
