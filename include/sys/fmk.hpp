	...
	typedef class Framework {
		public:
			...
			enum class check_t : uint8_t {
				...
				SPACE           = 0x03, // Флаг проверки на пробел
				LATIAN          = 0x04, // Флаг проверки на латинские символы
				NUMBER          = 0x05, // Флаг проверки на число
				DECIMAL         = 0x06, // Флаг проверки на число с плавающей точкой
				PSEUDO_NUMBER   = 0x07, // Флаг проверки на псевдо-число
				PRESENCE_LATIAN = 0x08  // Флаг проверки наличия латинских символов в строке
			};
		private:
			/**
