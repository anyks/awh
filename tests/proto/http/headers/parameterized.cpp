 ...
 *
 * @brief Параметризованные тесты контейнера HTTP-заголовков — прогон подготовленных наборов входных данных через
 *        методы модуля с проверкой регистронезависимого поиска полей,
