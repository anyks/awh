 ...
 *
 * @brief Статические тесты провайдеров HTTP-сообщений — проверка создания и сброса объекта модуля,
 *        а также корректности формирования и сериализации структуры HTTP-запроса клиента и HTTP-ответа сервера
 *
