 ...
 *
 * @brief Параметризованные тесты модуля HTTP-авторизации — прогон подготовленных наборов входных данных через методы
 *        модуля с проверкой формирования и проверки заголовков схем Basic, Bearer,
