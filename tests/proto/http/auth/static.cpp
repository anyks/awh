 ...
 *
 * @brief Статические тесты модуля HTTP-авторизации — проверка создания и сброса объекта модуля,
 *        а также корректности формирования и проверки заголовков схем Basic, Bearer,
