 ...
 *
 */
TEST_F(Quic2Fixture, CryptoInitialKeysTest){
 ...
 *
 */
TEST_F(Quic2Fixture, CryptoSealClientInitialTest){
	// Ключи защиты пакетов обоих направлений
	crypto::keys_t client, server;
	// Выводим ключи Initial из DCID клиента
	ASSERT_TRUE(crypto::initial(this->makeCid(this->unhex(CLIENT_DCID)), client, server));
 ...
 *
 */
TEST_F(Quic2Fixture, CryptoOpenClientInitialTest){
	// Ключи защиты пакетов обоих направлений
	crypto::keys_t client, server;
	// Выводим ключи Initial из DCID клиента
	ASSERT_TRUE(crypto::initial(this->makeCid(this->unhex(CLIENT_DCID)), client, server));
 ...
 *
 */
TEST_F(Quic2Fixture, CryptoServerInitialTest){
	// Ключи защиты пакетов обоих направлений
	crypto::keys_t client, server;
	// Выводим ключи Initial из DCID клиента
	ASSERT_TRUE(crypto::initial(this->makeCid(this->unhex(CLIENT_DCID)), client, server));
 ...
 *
 */
TEST_F(Quic2Fixture, CryptoRetryTagTest){
 ...
 *
 */
TEST_F(Quic2Fixture, CryptoChaChaShortHeaderTest){
 ...
 *
 */
TEST_F(Quic2Fixture, CryptoOpenTamperedTest){
	// Ключи защиты пакетов обоих направлений
	crypto::keys_t client, server;
	// Выводим ключи Initial из DCID клиента
	ASSERT_TRUE(crypto::initial(this->makeCid(this->unhex(CLIENT_DCID)), client, server));
 ...
 *
 */
TEST_F(Quic2Fixture, CryptoReservedBitsTest){
	// Ключи защиты пакетов обоих направлений
	crypto::keys_t client, server;
	// Выводим ключи Initial из DCID клиента
	ASSERT_TRUE(crypto::initial(this->makeCid(this->unhex(CLIENT_DCID)), client, server));
 ...
 *
 */
TEST_F(Quic2Fixture, CryptoSealRollbackTest){
	// Ключи защиты пакетов обоих направлений
	crypto::keys_t client, server;
	// Выводим ключи Initial из DCID клиента
	ASSERT_TRUE(crypto::initial(this->makeCid(this->unhex(CLIENT_DCID)), client, server));
 ...
 *
 */
TEST_F(Quic2Fixture, CryptoOpenWithoutKeysTest){
 ...
 *
 */
TEST_F(Quic2Fixture, CryptoUpdateHeaderKeyTest){
	// Ключи защиты пакетов обоих направлений
	crypto::keys_t client, server;
	// Выводим ключи Initial из DCID клиента
	ASSERT_TRUE(crypto::initial(this->makeCid(this->unhex(CLIENT_DCID)), client, server));
