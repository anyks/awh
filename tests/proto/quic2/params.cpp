 ...
 *
 */
TEST_F(Quic2Fixture, ParamsClientRoundTripTest){
 ...
 *
 */
TEST_F(Quic2Fixture, ParamsServerRoundTripTest){
	// Выходной буфер сборки
	std::string output;
 ...
 *
 */
TEST_F(Quic2Fixture, ParamsDefaultsTest){
	// Разобранные параметры транспорта
	params::params_t parsed;
	// Код ошибки транспорта
	error_t error = error_t::NO_ERROR;
 ...
 *
 */
TEST_F(Quic2Fixture, ParamsReferenceTest){
 ...
 *
 */
TEST_F(Quic2Fixture, ParamsUnknownIgnoredTest){
 ...
 *
 */
TEST_F(Quic2Fixture, ParamsMalformedTest){
	// Разобранные параметры транспорта
	params::params_t parsed;
	// Код ошибки транспорта
	error_t error = error_t::NO_ERROR;
