...
#include "../../../include/proto/quic2/handshake.hpp"
 ...
 *
 */
TEST_F(Quic2Fixture, HandshakeCompleteTest){
 ...
 *
 */
TEST_F(Quic2Fixture, HandshakeAlpnTest){
	// Создаём эндпоинт клиента
	handshake_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём эндпоинт сервера
	handshake_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, HandshakeTransportParamsTest){
	// Создаём эндпоинт клиента
	handshake_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём эндпоинт сервера
	handshake_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, HandshakeKeysTest){
	// Создаём эндпоинт клиента
	handshake_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём эндпоинт сервера
	handshake_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, HandshakeAlpnMismatchTest){
 ...
 *
 */
TEST_F(Quic2Fixture, HandshakeVerifyFailedTest){
 ...
 *
 */
TEST_F(Quic2Fixture, HandshakeMisuseTest){
