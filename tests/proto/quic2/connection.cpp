...
#include "../../../include/proto/quic2/crypto.hpp"
#include "../../../include/proto/quic2/connection.hpp"
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionEstablishTest){
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionInitialPaddingTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Выполняем подготовку соединения клиента
	::setup(client);
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionPeerParamsTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionCloseTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionCloseTrailingFrameTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionCloseCoalescedPacketTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionStopSendingCollectTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionClientAmplificationTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionPathRevertTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionPathChainTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionAmplificationTimerTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionEcnMigrationTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionMigrateCongestionResetTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionAckDelayTimeoutTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionPathResponseQueueTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionPathValidationPaddingTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionCryptoOverlapMismatchTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionMaxStreamsBoundTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionStreamOverlapMismatchTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionStreamFragmentLimitTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionIdleRestartOnSendTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionClosingPeriodTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionCloseAbortedByResetTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionDuplicateTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionGarbageTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionMisuseTest){
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
	// Выполняем подготовку соединения сервера
	::setup(server);
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionLossFirstFlightTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionLossServerFlightTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionTimerIdleTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, StreamEchoTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, StreamCoalescedHandshakeTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, StreamLargeTransferTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, StreamUnidirectionalTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, StreamLimitTest){
	// Транспортные параметры эндпоинтов
	params::params_t params;
	// Устанавливаем лимит данных соединения
	params.initialMaxData = 1048576;
 ...
 *
 */
TEST_F(Quic2Fixture, StreamFlowControlTest){
	// Транспортные параметры эндпоинтов
	params::params_t params;
	// Устанавливаем лимит данных соединения
	params.initialMaxData = 1048576;
 ...
 *
 */
TEST_F(Quic2Fixture, StreamResetTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, StreamStopSendingTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, StreamLossTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionIdleTimeoutTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionCloseRetransmitTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, VersionNegotiationTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionLostHandshakeFlightTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionRetireRetransmitTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
	 ...
	 */
	for(uint8_t i = 0; i < awh::quic2::proto::RESET_TOKEN_SIZE; i++)
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionAckIntegrityTest){
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionAckRangeMergeTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionHandshakeReorderTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionLossyControlTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionLossyPathTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, KeyUpdateReorderTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, KeyUpdatePreviousDiscardTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, KeyUpdateTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, AeadConfidentialityUpdateTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, AeadConfidentialityLimitTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, AeadIntegrityLimitTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionIdRotationTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, CongestionControlTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, AntiAmplificationLimitTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, AntiAmplificationResumeTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, DatagramSizeBudgetTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, StreamStopSendingBeforeFinCreditTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, StreamStopSendingAfterFinCreditTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, StreamRoundRobinTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, StreamCollectTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionReplayWindowTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, CongestionPersistentTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, CongestionPersistentReorderTest){
	/**
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionAckDelayTest){
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionClosingIgnoresFramesTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionStatelessResetTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionForeignResetTokenTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, RetryTokenAddressBindingTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, RetryTokenExpiryTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionVerifyWithCaTest){
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionVerifyWithoutCaTest){
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionExternalContextTest){
	// Объект фреймворка
	awh::fmk_t fmk;
	// Объект логирования
	awh::log_t log(&fmk);
	// Отдельное окружение транспортной безопасности с собственным кодером
	Quic2Security security(&fmk, &log);
	// Создаём соединение клиента
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionPathValidationTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionMigrationDetectTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionMigrationSpoofGuardTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionMigrationRoamingDisabledTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionStreamsBlockedTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionStreamsBlockedRaiseTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionCloseHandshakeSpacesTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionMigrateTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionEcnEchoTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionEcnCongestionTest){
	/**
	 ...
	 *
	 */
	auto run = [](Quic2Security * security, awh::log_t * log, const awh::event::ecn_t ecn) noexcept -> uint64_t {
		// Создаём соединение клиента
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionSessionResumeTest){
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionIssuedCidsTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionEarlyDataTest){
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionEarlyDataRejectTest){
	// Сериализованный билет возобновления, полученный от сервера
	std::string ticket = "";
	/**
	 * Выполняем первое соединение ради билета возобновления
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionEcnValidationTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionEcnValidationPassTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionEcnValidationPartialTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionNewTokenTest){
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionNewTokenRejectTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionPreferredAddressTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionPathValidationTimeoutTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionSoakTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionCollectReferencedTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionFuzzUnauthenticatedTest){
	// Состояние генератора псевдослучайных чисел с фиксированным зерном
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionFuzzPayloadTest){
	// Состояние генератора псевдослучайных чисел с фиксированным зерном
	...
	for(size_t round = 0; round < 200; round++){
		...
		if(client.state() == connection_t::state_t::CLOSING)
			...
			ASSERT_NE(awh::quic2::errorName(client.error()), "UNKNOWN_ERROR");
	}
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionMigrateGuardTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionMigrateReservedOnlyTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionForcedRetireCidTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionPreferredCidReservedTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionRelocationProbingTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionDatagramTest){
	/**
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionDatagramUnsupportedTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
...
TEST_F(Quic2Fixture, ConnectionStatelessResetKeyTest){
	 ...
	 */
	ASSERT_TRUE(awh::quic2::reset(reset, key, target, connection_t::MAX_DATAGRAM_SIZE));
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionStatelessResetForeignTest){
	...
	ASSERT_TRUE(awh::quic2::resetKey(key));
	ASSERT_TRUE(awh::quic2::resetKey(foreign));
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
	...
	ASSERT_TRUE(awh::quic2::reset(reset, foreign, client.dcid(), connection_t::MAX_DATAGRAM_SIZE));
	// Продвигаем тестовые часы
	now += 5;
	// Передаём пакет сброса клиенту
	ASSERT_EQ(client.read(reinterpret_cast <const uint8_t *> (reset.data()), reset.size(), now), status_t::OK);
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionStatelessResetBoundsTest){
	...
	ASSERT_FALSE(awh::quic2::reset(reset, key, cid, 21));
	// Проверяем что на датаграмму чуть большего размера сброс собирается
	ASSERT_TRUE(awh::quic2::reset(reset, key, cid, 32));
	...
	ASSERT_FALSE(awh::quic2::reset(reset, "", cid, 1200));
	// Выведенный токен сброса без сохранения состояния
	uint8_t token[awh::quic2::proto::RESET_TOKEN_SIZE];
	// Проверяем что вывод токена на общем ключе выполнен
	ASSERT_TRUE(awh::quic2::resetToken(key, cid, token));
	/**
	 ...
	 */
	uint8_t repeat[awh::quic2::proto::RESET_TOKEN_SIZE];
	// Выполняем повторный вывод токена сброса
	ASSERT_TRUE(awh::quic2::resetToken(key, cid, repeat));
	// Проверяем что повторно выведенный токен совпадает
	ASSERT_EQ(::memcmp(token, repeat, awh::quic2::proto::RESET_TOKEN_SIZE), 0);
	// Проверяем что без общего ключа вывод токена невозможен
	ASSERT_FALSE(awh::quic2::resetToken("", cid, token));
}
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionDisableActiveMigrationTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionPmtuDiscoveryTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionPmtuLimitMigrationTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionPmtuNarrowPathTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionPmtuCongestionTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionPmtuBlackHoleTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionStreamResurrectionGuardTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionStreamAdvertisedCapTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionStreamCapConfigurableTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionRetireFloodGuardTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
 ...
 *
 */
TEST_F(Quic2Fixture, ConnectionStreamBlockedOnceTest){
	// Создаём соединение клиента
	connection_t client(endpoint_t::CLIENT, this->_security->context(endpoint_t::CLIENT), this->_security->coder(), this->_log.get());
	// Создаём соединение сервера
	connection_t server(endpoint_t::SERVER, this->_security->context(endpoint_t::SERVER), this->_security->coder(), this->_log.get());
