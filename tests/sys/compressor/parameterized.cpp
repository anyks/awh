 ...
 *
 * @brief Параметризованные тесты подсистемы компрессии — прогон подготовленных наборов входных данных через методы
 *        модуля с проверкой блочного и потокового сжатия и распаковки данных всеми поддерживаемыми алгоритмами
 *
