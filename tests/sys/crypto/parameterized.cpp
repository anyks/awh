...
INSTANTIATE_TEST_SUITE_P(TestParameters, HashNumberTestParameterizedFixture,
	::testing::Values(
		HashNumberTestParameter({
			...
			740226331,
			3140300605531186333,
			{0x85, 0x13, 0xCD, 0x16, 0x44, 0x1B, 0x89, 0x71, 0x9D, 0xD1, 0x4A, 0x62, 0x1F, 0xDC, 0xBA, 0xD3}
		}),
		HashNumberTestParameter({
			"Anyks Framework, Anyks Framework, Anyks Framework, Anyks Framework, Anyks Framework, Anyks Framework!!!!!!!!!!!!!!!!?",
			3433845604,
			15431327962692613522,
			{0xA8, 0xDF, 0xFA, 0x1A, 0xD5, 0xAA, 0x6F, 0xCB, 0x26, 0xB6, 0x86, 0xE2, 0xA7, 0x21, 0x29, 0x9F}
		})
	)
);
