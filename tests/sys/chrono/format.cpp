...
INSTANTIATE_TEST_SUITE_P(TestParameters, FormatSpecifierParameterizedFixture,
	::testing::Values(
		...
		FormatSpecifierTestParameter({1743943021520, "%W", "14"}),
		...
		FormatSpecifierTestParameter({1704067200000, "%W", "00"}),
		...
		FormatSpecifierTestParameter({1709208000000, "%U", "09"}),
		...
		FormatSpecifierTestParameter({1735689599999, "%W", "52"}),
		...
		FormatSpecifierTestParameter({1762084800000, "%W", "44"}),
