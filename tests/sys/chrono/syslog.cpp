 ...
 *          сам. Модуль подставляет текущий год, а если получившаяся дата оказывается
 *          в будущем - предыдущий: записи системного журнала описывают прошедшее, и
 *          декабрьская запись, прочитанная в январе, относится к минувшему году. Так
 *          же поступают rsyslog и syslog-ng
 *
 */
