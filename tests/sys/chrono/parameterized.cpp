...
TEST_F(ChronoFixture, DSTChronoTest){
	...
	/**
	 * Осенний переход назначен на 02:00 летнего времени, а поля метод принимает в
	 * стандартном времени зоны: 02:00 летнего и есть 01:00 стандартного. Прежде оба
	 * перехода считались по одному порогу, отчего осенний приходился на час позже
	 * положенного, и сводные зоны Северной Америки расходились с системным календарём
	 * ровно на этот час - по 29 случаев на каждую зону за 2007-2035 годы
	 */
	// 1-е воскресенье ноября, до 01:00 (Sun, 02 Nov 2025 00:00:00 UTC) - ещё действует
	ASSERT_TRUE(this->_chrono->dst(1762041600000));
	// 1-е воскресенье ноября, с 01:00 (Sun, 02 Nov 2025 01:00:00 UTC) - уже не действует
	ASSERT_FALSE(this->_chrono->dst(1762045200000));
