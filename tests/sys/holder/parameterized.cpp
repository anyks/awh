 ...
 *
 * @brief Параметризованные тесты модуля холдера — прогон подготовленных наборов входных данных через методы модуля с
 *        проверкой захвата состояния и его автоматического восстановления при выходе из области видимости
 *
