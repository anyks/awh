 ...
 *
 * @brief Параметризованные тесты модуля работы с версиями — прогон подготовленных наборов входных данных через методы
 *        модуля с проверкой разбора строкового представления версии, её сравнения и обратного преобразования
 *
