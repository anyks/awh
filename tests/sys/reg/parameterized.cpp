 ...
 *
 * @brief Параметризованные тесты модуля регулярных выражений — прогон подготовленных наборов входных данных через
 *        методы модуля с проверкой компиляции и кеширования шаблонов PCRE2, поиска совпадений и извлечения групп
 *
