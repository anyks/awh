 ...
 *
 * @brief Статические тесты модуля регулярных выражений — проверка создания и сброса объекта модуля,
 *        а также корректности компиляции и кеширования шаблонов PCRE2, поиска совпадений и извлечения групп
 *
