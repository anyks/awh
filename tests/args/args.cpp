...
TEST(ArgsArgs, Environment) {
	...
	ASSERT_EQ(::setenv("AWHTEST_NAME", "value", 1), 0);
	/**
	 ...
	 */
	ASSERT_EQ(::setenv("AWHTESTING_NAME", "foreign", 1), 0);
