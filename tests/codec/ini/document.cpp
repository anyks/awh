 ...
 *       один лишь путь, и прямой вызов сборку там валит. Указал на это владелец
 *       кодека CEF: проверки кодеков собираются ОДНОЙ программой, и три моих вызова
...
TEST(CodecIniDocument, EveryFailedSaveIsAnnounced){
	 ...
	 *          кодеков. Указал на разряд этот владелец кодеков JSON, XML и CSV
	 */
