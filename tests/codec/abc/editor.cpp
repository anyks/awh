 ...
 *
 * @details Решение: данные уже в памяти, и отдавать их до фиксации ничего не стоит, а не
 *          отдавать - значит обязать потребителя держать их вторым списком
 *
 */
 ...
 *       а не выведено». Расхождение это решено 02.09.2026 в пользу договора:
 ...
 *          сам укладчик
 *
 * @note Заведена по приёму, отданному кодеком разметки 05.09.2026: щуп подменою причин
