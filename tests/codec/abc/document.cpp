 ...
 *       вместо `~1`
 *
 * @note Находка пришла от владельца моста, померившего то же у ABC, и подтвердилась у
 *       таблицы CSV независимо. Строгость (знак отмены, за каким не стоит нуля либо
 *       единицы, делает путь недействительным) взята единою с JSON: мягкость означала
 *       бы, что имя `t~x` достижимо двояко
 *
 */
