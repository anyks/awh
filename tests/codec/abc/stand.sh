...
#          один кодек
#
# @note Кадр, оглавление, правка и подпись стендом не берутся: они опираются на модули
#       сжатия и шифрования, а те тянут за собою третью сторону. Стенд стережёт вид
#       записи — порядок октетов, знаковость и выравнивание, — а он весь в ядре
#
