...
TEST(CodecJsonReader, CounterIntuitiveCodesHaveTheirReasons) {
	 ...
	 *
	 * @note Коды эти заведены решением владельца от 01.09.2026: прежде оба вместилища
