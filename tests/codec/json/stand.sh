...
#          проверки выходит без сборки библиотеки целиком. Полная сборка её на стендах
...
#
#              sh tests/codec/json/stand.sh
#              FLAGS=-DDEBUG_MODE sh tests/codec/json/stand.sh
#
#
...
#       повтором имён
$COMPILER $OPTIONS $OBJECTS -L"$GTEST/lib" -lgtest -lgtest_main -pthread $SYSTEM_LIBS $ZLIB -o "$OUTPUT/json-tests"
