...
TEST(CodecSysLogDocument, Timestamps) {
	 ...
	 *
	 * @note Дефект чужого модуля, доложен по месту. Обходить его здесь нельзя: обход
 ...
 *          доводу: спрашивать надо не «отвергает ли неведомое имя», а «находит ли
 *          хоть что-нибудь»
 *
 ...
 *
 * @warning Разряд этот назван 08.09.2026 и встречен за день трижды: «тел ДВА,
 ...
 *
 * @note Заведён 15.09.2026 по разряду, взятому у кодеков JSON: «поле заполнено,
