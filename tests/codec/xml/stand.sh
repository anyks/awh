...
#
#              sh tests/codec/xml/stand.sh
#              FLAGS=-DDEBUG_MODE sh tests/codec/xml/stand.sh
#
#
...
#       повтором имён
$COMPILER $OPTIONS $OBJECTS -L"$GTEST/lib" -lgtest -lgtest_main -pthread $SYSTEM_LIBS $ZLIB -o "$OUTPUT/xml-tests"
