...
TEST(CodecXmlReader, EncodingImpositionTiming) {
	 ...
	 *
	 * @note Правлено 08.09.2026 решением владельца закрыть расхождения кодеков: прежде
 ...
 *
 * @note Заведено 08.09.2026 решением владельца закрыть расхождения кодеков: все три кодека -
