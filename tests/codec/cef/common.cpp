 ...
 *          отсутствие спроса
 *
 * @note Перенято у кодека CSV 04.09.2026: там часть владеющего значения таблицы CSV
...
TEST(CodecCefCommon, Messages) {
	 ...
	 *          во всех трёх наборах. Собственная беда того же дня: код FILE_NOT_READ (ныне граница - VALUE_TOO_LONG)
