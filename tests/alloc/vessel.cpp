 ...
 *       повторов беда не лечится, лечится барьером. Правило принесено со стороны
 *       15.09.2026: снятие замка у склада давало падение лишь в четырёх прогонах из
 *       пяти, покуда не был поставлен одновременный пуск
 *
