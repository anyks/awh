...
INSTANTIATE_TEST_SUITE_P(TestParameters, UriTestParsingParameterizedFixture,
	::testing::Values(
		...
		UriTestParsingParameter({
			...
			"https://www.example.com/%D0%B3%D1%80%D0%B8%D0%B3%D0%BE%D1%80%D0%B8%D0%B9/%D0%BB%D0%B8%D1%87%D0%BD%D1%8B%D0%B9%20%D0%BA%D0%B0%D0%B1%D0%B8%D0%BD%D0%B5%D1%82/%D0%B1%D0%B0%D0%BB%D0%B0%D0%BD%D1%81?%D0%B8%D0%B4%D0%B5%D0%BD%D1%82%D0%B8%D1%84%D0%B8%D0%BA%D0%B0%D1%82%D0%BE%D1%80=%D0%B3%D0%BE%D0%B3%D0%B0&%D0%B7%D0%B0%D0%BF%D1%80%D0%BE%D1%81=%D0%BF%D1%8F%D1%82%D1%8C&checksum=\"1081aa143eac8936\"#%D0%BF%D0%B5%D1%80%D0%B5%D0%B9%D1%82%D0%B8%20%D0%B2%20%D0%BD%D0%B8%D0%B7",
			awh::uri_t::type_t::HTTPS,
			awh::uri_t::item_t::URI,
			awh::uri_t::format_t::SMART,
		...
		UriTestParsingParameter({
			...
			"frag",
			"https://user:password@[2001:db8::1]/api/v1/?query=1&id=123#frag",
			"https://user:password@[2001:DB8::1]",
			awh::uri_t::type_t::HTTPS,
		...
		UriTestParsingParameter({
			...
			"frag",
			"https://user:password@[2001:db8::1]/api/v1/?query=1&id=123#frag",
			"https://user:password@[2001:DB8::1]:443",
			awh::uri_t::type_t::HTTPS,
			awh::uri_t::item_t::ORIGIN,
			awh::uri_t::format_t::FULL,
			{"api", "v1"},
...
INSTANTIATE_TEST_SUITE_P(TestParameters, UriTestMatchParameterizedFixture,
	::testing::Values(
		UriTestMatchParameter({
			...
			{
				"http://www.example.com/addr/data/test?id=222&anyks=com#best",
		...
		UriTestMatchParameter({
			...
			{
				"https://127.0.0.1/addr/data/test?id=222&anyks=com#best",
		...
		UriTestMatchParameter({
			...
			{
				"https://[2001:DB8::1]/addr/data/test?id=222&anyks=com#best",
