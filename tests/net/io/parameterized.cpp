 ...
 *
 */
struct IoTestParameter {
	// Тип URL-адреса
	awh::io_t::types_t type = awh::io_t::types_t::NONE;
	// Порт URL-адреса
	uint32_t port = 0;
	// Хост URL-адреса
	std::string host = "";
...
TEST_P(NwtTestParameterizedFixture, NwtTestingTest){
	...
	// Устанавливаем русские буквы для объекта работы со списком параметров URL
	this->_nwt->letters("абвгдеёжзийклмнопрстуфхцчшщъыьэюя");
