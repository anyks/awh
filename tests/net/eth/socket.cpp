 ...
 */
	 ...
	 *          пара macro_push.hpp и macro_pop.hpp имена эти снимает
	 *
	 * @note Обращения к членам защищены той же парой ниже - по правилу, изложенному у
	 *       macro_push.hpp: заголовки AWH защищают свои объявления, а называющий такие
...
/**
 * Снимаем на время файла макросы, чьи имена заняты членами перечислений AWH
 */
...
/**
 * Возвращаем снятые макросы потребителю
 */
