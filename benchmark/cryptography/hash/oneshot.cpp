...
namespace {
	 ...
	 *
	 * @details Пороги сняты НАСТОЯЩЕЙ выпускной сборкой проекта по дну девяти
	 *          систем с двукратным запасом к нему. Прежняя редакция велела
	 *          калибровать по НЕОПТИМИЗИРОВАННОЙ сборке с четырёхкратным
	 *          запасом, и оттого пороги стояли ниже измеренного вчетверо -
	 *          сорок пять раз: они ловили лишь полную поломку сценария.
	 *          Отладочная сборка мерой не служит, см. README набора
	 *
	 ...
	 *
	 */
	static constexpr double LARGE_THRESHOLD = 4200000000.0;
	/**
