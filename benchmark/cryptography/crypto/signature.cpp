...
namespace {
	 ...
	 *
	 * @details Пороги откалиброваны по отладочной сборке с пятикратным запасом, а не с
	 *          двукратным, как у прочих сценариев набора: самый медленный из стендов
	 *          равномерно впятеро медленнее рабочей машины, и двукратный запас ловил бы
	 *          там не регрессию, а саму машину. Регрессию в разы пятикратный запас
	 *          по-прежнему ловит
	 *
	 */
	static constexpr double ED25519_SIGN_THRESHOLD = 24000.0;
	static constexpr double ED25519_VERIFY_THRESHOLD = 9000.0;
	static constexpr double ECDSA_SIGN_THRESHOLD = 16000.0;
