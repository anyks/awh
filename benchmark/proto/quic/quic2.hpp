...
#ifndef __AWH_PROTO_QUIC2_BENCHMARK__
#define __AWH_PROTO_QUIC2_BENCHMARK__
...
namespace awh {
	...
	namespace benchmark {
		...
		namespace quic2 {
			 ...
			 *
			 */
			void configure(awh::quic2::connection_t & connection) noexcept;
			/**
			 ...
			 *
			 */
			bool establish(awh::quic2::connection_t & client, awh::quic2::connection_t & server, uint64_t & now) noexcept;
		};
	};
};

#endif // __AWH_PROTO_QUIC2_BENCHMARK__
