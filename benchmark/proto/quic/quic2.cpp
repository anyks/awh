 ...
 *
 */
awh::tls::Coder & awh::benchmark::quic2::Security::coder() noexcept {
 ...
 *
 */
awh::tls::Coder::id_t awh::benchmark::quic2::Security::context(const awh::quic2::endpoint_t endpoint) const noexcept {
 ...
 *
 */
awh::benchmark::quic2::Security::Security(const awh::fmk_t * fmk, const awh::log_t * log) noexcept :
 ...
 *
 */
awh::benchmark::quic2::Security::~Security() noexcept {
 ...
 *
 */
awh::benchmark::quic2::Security & awh::benchmark::quic2::security() noexcept {
 ...
 *
 */
void awh::benchmark::quic2::configure(awh::quic2::connection_t & connection) noexcept {
	// Транспортные параметры эндпоинта
	awh::quic2::params::params_t params;
	/**
 ...
 *
 */
bool awh::benchmark::quic2::establish(awh::quic2::connection_t & client, awh::quic2::connection_t & server, uint64_t & now) noexcept {
	...
	for(size_t i = 0; i < 16; i++){
		...
		if((client.state() == awh::quic2::connection_t::state_t::CONNECTED) &&
		   (server.state() == awh::quic2::connection_t::state_t::CONNECTED))
