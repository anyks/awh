...
namespace {
	 ...
	 *
	 */
	static constexpr double ENCODE_THRESHOLD = 15000.0;
	/**
	 * @brief Порог скорости декодирования блоков заголовков в блоках в секунду
	 *
	 */
	static constexpr double DECODE_THRESHOLD = 80000.0;
	/**
	 ...
	 *
	 */
	static constexpr double RATIO_THRESHOLD = 18.0;
	/**
	 ...
	 *
	 */
	static constexpr double DECODE_ALLOCATIONS_THRESHOLD = 0.5;
