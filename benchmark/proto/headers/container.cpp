...
namespace {
	 ...
	 *          выделяют по разу, а ёмкость набора набирается за те же выделения.
	 *          Десять полей - десять выделений; одиннадцатое означало бы работу,
	 *          которой контейнер не делал.
	 *
	 ...
	 *
	 */
	static constexpr double BUILD_ALLOCATIONS = 10.0;
