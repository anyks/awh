...
namespace {
	 ...
	 *
	 */
	// Дно ряда: 3.11 МБ/с у DragonFly (замер 07.09.2026 по двенадцати машинам)
	constexpr double PARSE_THRESHOLD = 2.0;
	 ...
	 *
	 */
	// Дно ряда: 19 840 обходов/с у OpenBSD (замер 07.09.2026 по двенадцати машинам)
	constexpr double TRAVERSAL_THRESHOLD = 15000.0;
