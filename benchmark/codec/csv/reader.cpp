...
namespace {
	 ...
	 *          (14.08.2026) и назначены по самому медленному из них, делённому надвое -
	 *          тем же правилом, что и у контейнера INI. Самым медленным на чтении
	 *          оказался OpenBSD: он отстаёт от рабочей машины вдесятеро, тогда как
	 *          прочие стенды - втрое-впятеро
	 *
	 ...
	 *
	 * @note Порог снят по самому медленному стенду с двукратным запасом: OpenBSD
	 *       даёт 12.09 мкс против 1.45 у рабочей машины
	 *
	 */
