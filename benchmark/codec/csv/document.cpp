...
namespace {
	 ...
	 *          же правилом, что и пороги чтения
	 *
	 */
	 ...
	 *
	 *
	 * @warning Порог выставлен ОЖИДАНИЕМ, а не замером по машинам, и держится ВПРИТЫК -
	 *          запас всего в пятую часть. Доли у него разнородны сильнее, чем у прочих
	 *          отношений набора: сборка таблицы память заводит, а потоковая выдача не
	 *          заводит вовсе, - и машина с дорогим раздатчиком памяти двинет знаменатель,
	 *          не тронув числителя. Из всех порогов-отношений этот первый на замер по
	 *          машинам, и первою надобна машина с ИНЫМ раздатчиком. Довод общий смотри при
	 *          пороге подачи кусками у чтения
	 */
