...
namespace {
	 ...
	 *       давало 1 223 установки в секунду против нынешних 5 465 850 - на двадцати
	 ...
	 *       Порог поставлен между: он в тридцать три раза выше квадратичного пути
	 *       и с большим запасом ниже приращаемого даже на самом медленном стенде
	 *
	 */
	static constexpr double ASSEMBLY_THRESHOLD = 40000.0;
