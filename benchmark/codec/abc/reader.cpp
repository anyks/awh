...
namespace {
	 ...
	 *       давало запас всего 1.06, а разброс самой машины ±1 %. Порог такой краснел бы
	 *       у Solaris на всякой правке разбора, медленнее на пять сотых, - не будучи
	 *       регрессией нигде более. Ныне запас 1.16. Замеры на стендах гонять ПО ОДНОМУ:
	 *       соседство двенадцати машин одного сервера роняло этот же сценарий на 10 %
	 *
	 */
	static constexpr double READ_NUMBERS_THRESHOLD = 11.0;
	/**
	 ...
	 *
	 * @note Порог ослаблен 23.08.2026 по карте двенадцати систем: дно 101.73 у Solaris
	 *       давало запас всего 1.09, а разброс самой машины ±1 %. Порог такой краснел бы
	 *       у Solaris на всякой правке разбора, медленнее на пять сотых, - не будучи
	 *       регрессией нигде более. Ныне запас 1.16. Замеры на стендах гонять ПО ОДНОМУ:
	 *       соседство двенадцати машин одного сервера роняло этот же сценарий на 10 %
	 *
	 */
	static constexpr double READ_BLOBS_THRESHOLD = 88.0;
	/**
	 * @brief Порог пропускной способности чтения записи с глубокой вложенностью
	 *
	 * @note Порог ослаблен 23.08.2026 по карте двенадцати систем: дно 2.64 у Solaris
	 *       давало запас всего 1.06, а разброс самой машины ±1 %. Порог такой краснел бы
	 *       у Solaris на всякой правке разбора, медленнее на пять сотых, - не будучи
	 *       регрессией нигде более. Ныне запас 1.15. Замеры на стендах гонять ПО ОДНОМУ:
	 *       соседство двенадцати машин одного сервера роняло этот же сценарий на 10 %
	 *
	 */
