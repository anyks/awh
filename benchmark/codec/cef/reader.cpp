...
namespace {
	 ...
	 *          МБ/с. Порог взят по ДНУ трёх проверенных машин с запасом
	 *
	 */
	 ...
	 *          amd64 (g++ 12.2, glibc): 12 530. Порог взят по ДНУ трёх проверенных машин
	 *          с запасом втрое: дно ходит втрое от машины к машине, и OpenBSD, машина
	 *          заведомо медленнейшая, ещё не пройдена
	 *
	 ...
	 *          Debian 12 amd64: 2.56 раза. Мера отношением от машины почти не зависит -
	 *          тем она и хороша: три разные машины уложились в тринадцать процентов, тогда
	 *          как меры абсолютные ходят втрое
	 *
	 */
	 ...
	 *          запись, 05.09.2026 на FreeBSD amd64: 15 - число в число, а на Debian 12
	 *          amd64 (libstdc++): 22
	 *
