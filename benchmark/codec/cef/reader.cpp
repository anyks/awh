 ...
 *        выделений памяти
 *
 * @note Пороги, здесь выставленные, проверены НА ДЕВЯТИ МАШИНАХ к 06.09.2026 - macOS,
 *       FreeBSD, OpenBSD, Debian (glibc), Alpine (musl), NetBSD, Solaris, OpenIndiana
 *       и DragonFly. Ни один из пяти стендов, добавленных последними, дна ни у одного
 *       сценария не сдвинул: числа их легли серединою ряда. Сводная таблица по всем
 *       девяти - в README.md рядом
 *
