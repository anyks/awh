...
namespace {
	 ...
	 *          МБ/с. Порог взят по ДНУ трёх проверенных машин с запасом вчетверо
	 *
	 */
	 ...
	 *          запись, 05.09.2026 на FreeBSD amd64: 3 и на Debian 12 amd64 (libstdc++):
	 *          3 - число в число на всех трёх, стандартной библиотеке вопреки: сборка
	 *          строк коротких не заводит вовсе, оттого запас её и не задевает. Запас держится широким, покуда стенд на libstdc++ не пройден:
