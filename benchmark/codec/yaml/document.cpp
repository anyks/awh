...
namespace {
	 ...
	 *
	 * @note Съём вёлся ПО ОДНОМУ прогону на машину, а не наихудшим из нескольких
	 *       отдельных процессов. Разброс между процессами одной машины у показателей
	 *       такого рода бывает заметен - до четверти, - и «десять сотых» есть покуда
	 *       наблюдение по одному образцу с машины, а не доказанный предел. Запас втрое
	 *       на это и держится
	 *
	 */
