 ...
 *
 * @brief Заголовочный файл бенчмарков контейнера TOML — общее окружение сценариев,
 ...
 */
#include "../../main.hpp"
#include "../../../include/codec/toml/toml.hpp"
...
namespace awh {
	...
	namespace benchmark {
		/**
		 * @brief Пространство имён бенчмарков контейнера TOML
		 *
		 ...
		 *       самого модуля awh::codec, а имя toml - пространство имён контейнера
		 *
		 */
		namespace settings {
			/**
			 ...
			 *
			 * @details Множество таблиц нагружает учёт объявленных имён и указатели
			 *          дерева: поиск таблицы попарным сличением имён обращает разбор в
			 *          квадратичный
			 *
			 * @return эталонный текст настроек
			 *
			 */
			const std::string & tables() noexcept;
		};
	};
};
