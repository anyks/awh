...
namespace {
	 ...
	 * @warning Имя сценария обещает больше, нежели порог стережёт, и решить, как быть с
	 *          этим, надлежит владельцу: прежний порог 1.10 утверждал выигрыш и оттого
	 *          отказывал у Debian на холодном прогоне без всякой регрессии
	 */
