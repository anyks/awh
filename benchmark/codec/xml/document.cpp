...
namespace {
	 ...
	 *
	 */
	static constexpr double TREE_SOAP_THRESHOLD = 12.0;
	/**
	 * @brief Порог пропускной способности сборки дерева крупного документа
	 *
	 */
	static constexpr double TREE_LARGE_THRESHOLD = 18.0;
	/**
	 ...
	 *
	 */
	static constexpr double TREE_WALK_THRESHOLD = 28000000.0;
	/**
