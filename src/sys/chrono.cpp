...
namespace {
	...
	/**
	 * @brief Проверка, является ли символ десятичной цифрой ('0'–'9')
	 *
	...
	/**
	 * @brief Проверка, является ли символ заглавной латинской буквой ('A'–'Z')
	 *
	 * @param letter проверяемый символ
	...
	/**
	 * @brief Проверка, является ли символ строчной латинской буквой ('a'–'z')
	 *
	 * @param letter проверяемый символ
	...
	/**
	 * @brief Проверка, является ли символ латинской буквой (заглавной или строчной)
	 *
	 * @param letter проверяемый символ
	...
	/**
	 * @brief Проверка, является ли символ словесным (буква, цифра или '_')
	 *
	 * @param letter проверяемый символ
	...
	/**
	 * @brief Проверка, является ли символ пробельным
	 *
	 * @param letter проверяемый символ
