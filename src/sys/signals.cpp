...
void awh::Signals::start() noexcept {
	 ...
	 */
		 ...
		 *       обработчиков наравне с прочими семью сигналами (решение владельца от
		 *       08.09.2026: остановили сигналы - значит модуль больше не работает, и
		 *       оставлять за собой изменённое поведение процесса незачем)
		 *
