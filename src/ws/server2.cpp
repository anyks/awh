 ...
 */
awh::server::auth_t::data_t awh::server::Websocket::authorization() const noexcept {
 ...
 */
void awh::server::Websocket::authorization(const server::auth_t::data_t & data) noexcept {
