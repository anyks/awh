 ...
 */
	 ...
	 */
		...
		/**
		 * Подключаем заголовочные файлы для процессора x86_64
		 */
		#include <emmintrin.h>
		/**
	 ...
	 */
		...
		/**
		 * Подключаем заголовочные файлы для процессора x86
		 */
		#include <emmintrin.h>
		/**
		 * Формируем функцию паузы для CPU
 ...
 */
	 ...
	 */
		...
		/**
		 * Подключаем заголовочные файлы для процессора x86/x86_64
		 */
		#include <emmintrin.h>
		/**
		 * Формируем функцию паузы для CPU
