 ...
 *
 * @note Если заголовок с указанным именем уже существует, все его вхождения
 *       заменяются новым значением. Если заголовок отсутствует — он добавляется.
 *
 * @param name    название заголовка
 * @param content содержимое заголовка
 * @return        общее количество заголовков
 */
size_t awh::http::Headers::emplace(string && name, string && content) noexcept {
 ...
 * @return        общее количество заголовков
 */
size_t awh::http::Headers::emplace(string && name, const char * content) noexcept {
	// Если название заголовка указано - удаляем все его прежние вхождения перед заменой
	if(!name.empty())
		// Удаляем все прежние вхождения заголовка с указанным названием
		this->erase(name);
 ...
 * @return        общее количество заголовков
 */
size_t awh::http::Headers::emplace(string_view name, string_view content) noexcept {
	// Если название заголовка указано - удаляем все его прежние вхождения перед заменой
	if(!name.empty())
		// Удаляем все прежние вхождения заголовка с указанным названием
		this->erase(name);
 ...
 * @return        общее количество заголовков
 */
size_t awh::http::Headers::emplace(string && name, const string & content) noexcept {
	// Если название заголовка указано - удаляем все его прежние вхождения перед заменой
	if(!name.empty())
		// Удаляем все прежние вхождения заголовка с указанным названием
		this->erase(name);
 ...
 * @return        общее количество заголовков
 */
size_t awh::http::Headers::emplace(const string & name, string && content) noexcept {
	// Если название заголовка указано - удаляем все его прежние вхождения перед заменой
	if(!name.empty())
		// Удаляем все прежние вхождения заголовка с указанным названием
		this->erase(name);
 ...
 * @return        общее количество заголовков
 */
size_t awh::http::Headers::emplace(const string & name, const char * content) noexcept {
	// Если название заголовка указано - удаляем все его прежние вхождения перед заменой
	if(!name.empty())
		// Удаляем все прежние вхождения заголовка с указанным названием
		this->erase(name);
 ...
 * @return        общее количество заголовков
 */
size_t awh::http::Headers::emplace(const string & name, const string & content) noexcept {
	// Если название заголовка указано - удаляем все его прежние вхождения перед заменой
	if(!name.empty())
		// Удаляем все прежние вхождения заголовка с указанным названием
		this->erase(name);
