 ...
 */
#include <proto/quic2/params.hpp>
 ...
 *
 */
awh::quic2::params::Preferred_Address::Preferred_Address() noexcept :
 ...
 *
 */
awh::quic2::params::Params::Params() noexcept :
 ...
 *
 */
awh::quic2::status_t awh::quic2::params::parser::decode(const uint8_t * data, const size_t size, const endpoint_t sender, params_t & output, error_t & error) noexcept {
 ...
 *
 */
bool awh::quic2::params::serialize::encode(string & output, const params_t & params, const endpoint_t sender) noexcept {
 ...
 *
 */
bool awh::quic2::params::serialize::early(string & output, const params_t & params) noexcept {
	/**
