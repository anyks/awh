 ...
 *
 */
size_t awh::quic2::varint::size(const uint64_t value) noexcept {
 ...
 *
 */
size_t awh::quic2::varint::sizeAt(const uint8_t first) noexcept {
 ...
 *
 */
size_t awh::quic2::varint::read(const uint8_t * data, const size_t size, uint64_t & value) noexcept {
 ...
 *
 */
size_t awh::quic2::varint::write(string & output, const uint64_t value) noexcept {
