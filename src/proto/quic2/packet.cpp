 ...
 *
 */
awh::quic2::packet::Header::Header() noexcept :
 ...
 *
 */
size_t awh::quic2::packet::packetNumberSize(const uint64_t pn, const uint64_t largestAcked) noexcept {
 ...
 *
 */
uint64_t awh::quic2::packet::decodePacketNumber(const uint64_t largestPn, const uint64_t truncated, const size_t pnSize) noexcept {
	/**
 ...
 *
 */
awh::quic2::status_t awh::quic2::packet::parser::header(const uint8_t * data, const size_t size, const size_t dcidSize, header_t & output, error_t & error) noexcept {
 ...
 *
 */
bool awh::quic2::packet::parser::packetNumber(const uint8_t * data, const size_t size, const size_t pnSize, uint64_t & output) noexcept {
 ...
 *
 */
awh::quic2::status_t awh::quic2::packet::parser::versions(const header_t & header, vector <uint32_t> & output, error_t & error) noexcept {
 ...
 *
 */
awh::quic2::status_t awh::quic2::packet::parser::retry(const header_t & header, string_view & token, uint8_t tag[proto::RETRY_TAG_SIZE], error_t & error) noexcept {
 ...
 *
 */
bool awh::quic2::packet::serialize::longHeader(string & output, const packet_t type, const uint32_t version, const cid_t & dcid, const cid_t & scid, string_view token, const uint64_t length, const uint64_t pn, const size_t pnSize) noexcept {
 ...
 *
 */
bool awh::quic2::packet::serialize::shortHeader(string & output, const cid_t & dcid, const uint64_t pn, const size_t pnSize, const bool keyPhase, const bool spin) noexcept {
 ...
 *
 */
bool awh::quic2::packet::serialize::versionNegotiation(string & output, const cid_t & dcid, const cid_t & scid, const uint32_t * versions, const size_t count) noexcept {
 ...
 *
 */
bool awh::quic2::packet::serialize::retry(string & output, const uint32_t version, const cid_t & dcid, const cid_t & scid, string_view token, const uint8_t tag[proto::RETRY_TAG_SIZE]) noexcept {
