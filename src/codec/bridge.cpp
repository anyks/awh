...
namespace {
	 ...
	 *
	 * @note Круга правка эта НЕ замыкает: обратное чтение отдаст имя правленое, а
	 *       не исходное - тем же свойством обладает и приставка `Item`, налагаемая
	 *       на имя, начатое цифрой. Замкнуть его нечем: разметка имён таких не несёт
	 */
