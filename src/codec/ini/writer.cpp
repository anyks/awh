...
bool awh::codec::ini::Writer::escape(const string_view value) noexcept {
	/**
	 * Если значение годным UTF-8 не является
	 *
	 ...
	 *
	 * @note Отказ здесь ЛУЧШЕ подмены знаком замены: подмена меняет данные потребителя
	 *       молча, а отказ называет причину и оставляет решение ему
	 *
