...
namespace {
	/**
	 * @brief Зерно свёртки записи имени поля отображения
	 *
	 * @details Зерно своё, а не общее с кадром: свёртки эти живут одним разбором и с
	 *          чужими нигде не встречаются, но одно зерно на разные надобности связало бы
	 *          их без нужды
	 *
	 */
	/**
