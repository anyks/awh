...
bool awh::codec::abc::Storage::open(const string & filename) noexcept {
	 ...
	 */
	/**
	 * @note Место это щупом 05.09.2026 названо слепым, и слепота его ЗАКОННА: отказ
	 *       наводится лишь отказом самого носителя, а поддельной файловой системы у
	 *       набора нет. Прочие пятнадцать мест хранилища стерегутся - в том числе
	 *       проверками кодеков, кладущих файлы через это же хранилище
	 */
