...
bool awh::codec::abc::Editor::open(source_t source, sink_t sink, const uint64_t length) noexcept {
	 ...
	 * работы да видом сличения, каковые розыском и берутся, - разряд принесён Николаем
	 *
	 ...
	 * опирается; опиралась одна лишь запись. Найдено 07.09.2026 ситом Николая: довод,
