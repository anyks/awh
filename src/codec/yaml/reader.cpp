 ...
 *          строка приходит сюда одною строкою исходной. Замерено дважды - счётчиком,
 *          поставленным на приход строки с переводом внутри: за 361 проверкой набора и за
 *          120 000 текстами ворошителя не сработал ни разу. Ветви свёртки, вторую и далее
 *          строку разбирающие, порчею не роняются ничем
 *
