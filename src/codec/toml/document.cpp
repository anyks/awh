...
bool awh::codec::toml::Document::spacious(const size_t length) noexcept {
	 ...
	 *          винит писавшего, - а стоит проверка ровно столько же. Урок принесён Геннадием
	 *          от кодека ABC, где он объявил износом два своих числа и, сличив по пяти
	 *          снимкам, нашёл оба промахами
	 *
	 ...
	 *       стареет громко, вместе со сборкой. Мерка принесена Геннадием от кодека ABC,
...
bool awh::codec::toml::Document::prune(const string & path) noexcept {
	 ...
	 *       владельцами прочих кодеков рамки. Примечание лгало: согласовано было обратное -
	 *       снос корня решается стандартом кодека, и у YAML, INI, TOML он успешен. Нашёл
	 *       это владелец ABC сличением erase("") по пяти кодекам разом
	 */
	if(route.empty()){
