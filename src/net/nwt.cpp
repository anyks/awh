...
/**
 * Инкапсулируем статические типы данных в анонимное пространство имён
 */
namespace {
	/**
...
/**
 * Инкапсулируем статические функции работы с доменными именами в анонимное пространство имён
 */
namespace {
	/**
...
/**
 * Инкапсулируем внутренние функции-помощники для собственных парсеров адресов в анонимное пространство имён
 */
namespace {
	/**
