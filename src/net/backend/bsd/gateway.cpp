					...
					DeleteRoute:
					{
						...
						if(rtm->rtm_addrs & RTA_IFP){
							...
							if(((rtm->rtm_addrs & RTA_GATEWAY) == 0) ||
							   ...
							   ((reinterpret_cast <struct sockaddr *> (sa))->sa_family != AF_LINK))){
