 ...
 */
void awh::server::AWH::subprotocols(const unordered_set <string> & subprotocols) noexcept {
 ...
 */
const unordered_set <string> & awh::server::AWH::subprotocols(const uint64_t bid) const noexcept {
