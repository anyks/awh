 ...
 * @param sid идентификатор схемы сети
 */
void awh::server::ProxySocks5::sendToCluster(const uint16_t sid) noexcept {
 ...
 */
void awh::server::ProxySocks5::sendToCluster(const uint16_t sid, const char * buffer, const size_t size) noexcept {
	// Выполняем отправку сообщения родительскому процессу
 ...
 */
void awh::server::ProxySocks5::sendToCluster(const uint16_t sid, const pid_t pid) noexcept {
 ...
 * @param size   размер бинарного буфера для отправки сообщения
 */
void awh::server::ProxySocks5::sendToCluster(const uint16_t sid, const pid_t pid, const char * buffer, const size_t size) noexcept {
	// Выполняем отправку сообщения дочернему процессу
 ...
 * @param sid идентификатор схемы сети
 */
void awh::server::ProxySocks5::broadcastToCluster(const uint16_t sid) noexcept {
 ...
 * @param size   размер бинарного буфера для отправки сообщения
 */
void awh::server::ProxySocks5::broadcastToCluster(const uint16_t sid, const char * buffer, const size_t size) noexcept {
	// Выполняем отправку сообщения всем дочерним процессам
