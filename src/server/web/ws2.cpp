 ...
 * @return       статус полученных данных
 */
int awh::server::WebSocket2::frameSignal(const int32_t sid, const uint64_t bid, const nghttp2_t::direct_t direct, const uint8_t type, const uint8_t flags) noexcept {
