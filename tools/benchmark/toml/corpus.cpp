...
int32_t main() noexcept {
	...
	static const pair_t PAIRS[] = {
		{"service", rival::service, awh::benchmark::settings::service},
		{"large", rival::large, awh::benchmark::settings::large},
		{"strings", rival::strings, awh::benchmark::settings::strings},
		{"numbers", rival::numbers, awh::benchmark::settings::numbers},
		{"arrays", rival::arrays, awh::benchmark::settings::arrays},
		{"tables", rival::tables, awh::benchmark::settings::tables},
	};
