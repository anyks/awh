...
int32_t main() noexcept {
	...
	static const pair_t PAIRS[] = {
		{"service", rival::service, awh::benchmark::config::service},
		{"repository", rival::repository, awh::benchmark::config::repository},
		{"large", rival::large, awh::benchmark::config::large},
		{"annotated", rival::annotated, awh::benchmark::config::annotated},
		{"sections", rival::sections, awh::benchmark::config::sections},
	};
