...
int32_t main(int32_t argc, char * argv[]){
	...
	cout << "Выполняем проверку является ли IP-адрес глобальным 46.39.230.51 == " << (addr.mode() == net_addr_t::mode_t::WAN) << endl << endl;
	...
	cout << "Выполняем проверку является ли IP-адрес локальным 192.168.31.12 == " << (addr.mode() == net_addr_t::mode_t::LAN) << endl << endl;
	...
	cout << "Выполняем проверку является ли IP-адрес зарезервированным 0.0.0.0 == " << (addr.mode() == net_addr_t::mode_t::SYS) << endl << endl;
	...
	cout << boolalpha;
	// Выполняем проверку является ли IP-адрес глобальным
	cout << "Выполняем проверку является ли IP-адрес глобальным [2a00:1450:4010:c0a::8b] == " << (addr.mode() == net_addr_t::mode_t::WAN) << endl << endl;
	...
	cout << boolalpha;
	// Выполняем проверку является ли IP-адрес локальным
	cout << "Выполняем проверку является ли IP-адрес локальным [::1] == " << (addr.mode() == net_addr_t::mode_t::LAN) << endl << endl;
	...
	cout << boolalpha;
	// Выполняем проверку является ли IP-адрес зарезервированным
	cout << "Выполняем проверку является ли IP-адрес зарезервированным [::] == " << (addr.mode() == net_addr_t::mode_t::SYS) << endl << endl;
