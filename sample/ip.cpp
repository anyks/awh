...
int32_t main(int32_t argc, char * argv[]){
	...
	cout << " [2001:0db8:11a3:09d7:1f34:8a2e:07a0:765d] || MIDDLE: " << net << " === LONGv4: " << net.get(net_t::format_t::LONG_IPV4) << " === MIDDLEv4: " << net.get(net_t::format_t::MIDDLE_IPV4) << " === SHORTv4: " << net.get(net_t::format_t::SHORT_IPV4) << " == SHORTv4Hex: " << net.get(net_t::format_t::HEX_IPV4) << " == SHORTv4Hex: " << net.get(net_t::format_t::OCTAL_IPV4) << endl;
	...
	net = "192.16.0.1";
	// Выводим IP-адрес в консоль
	cout << " 192.16.0.1 || LONG: " << net.get(net_t::format_t::LONG) << " === LONGv6: " << net.get(net_t::format_t::LONG_IPV6) << " === SHORTv6: " << net.get(net_t::format_t::SHORT_IPV6) << " === MIDDLEv6: " << net.get(net_t::format_t::MIDDLE_IPV6) << endl;
	...
	net = "192.168.3.192";
	// Выводим составную часть IP-адреса
	cout << " Вывод IP-адреса в 16-м формате: 192.168.3.192 || " << net.get(net_t::format_t::HEX_IPV4) << endl;
	// Выводим составную часть IP-адреса
	cout << " Вывод IP-адреса в 8-м формате: 192.168.3.192 || " << net.get(net_t::format_t::OCTAL_IPV4) << endl;
