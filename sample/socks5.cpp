...
int main(int argc, char * argv[]) noexcept {
	...
	// proxy.family(awh::core_t::family_t::NIX);
	// Устанавливаем тип сокета UDP TLS
	// proxy.sonet(awh::core_t::sonet_t::DTLS);
	// proxy.sonet(awh::core_t::sonet_t::TLS);
	// proxy.sonet(awh::core_t::sonet_t::UDP);
	// proxy.sonet(awh::core_t::sonet_t::TCP);
