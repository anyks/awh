 ...
 *
 * @brief Пример клиента UDP в режиме подключения — демонстрация привязки датаграммного сокета к удалённому адресу
 *        через фасад клиента и обмена датаграммами с сервером
 *
