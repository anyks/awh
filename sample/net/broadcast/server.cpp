 ...
 *
 * @brief Пример приёмника широковещательной рассылки —
 *        демонстрация привязки датаграммного сокета к широковещательному адресу и обработки принятых сообщений
 *
