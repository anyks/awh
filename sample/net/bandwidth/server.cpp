 ...
 *
 * @brief Пример сервера для измерения пропускной способности канала —
 *        демонстрация приёма непрерывного потока данных от клиента и подсчёта достигнутой скорости передачи
 *
