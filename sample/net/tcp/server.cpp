 ...
 *
 * @brief Пример сервера TCP на низкоуровневом движке ввода-вывода — демонстрация привязки слушающего сокета,
 *        приёма подключений, управления подписками и обслуживания клиентов
 *
