 ...
 *
 * @brief Пример сервера с передачей данных без копирования в пространство пользователя —
 *        демонстрация использования механизма splice при обслуживании клиентских подключений
 *
