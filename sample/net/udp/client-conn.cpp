 ...
 *
 * @brief Пример клиента UDP в режиме подключения на низкоуровневом движке ввода-вывода —
 *        демонстрация привязки датаграммного сокета к удалённому адресу и обмена датаграммами
 *
