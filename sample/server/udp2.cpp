 ...
 *
 * @brief Пример сервера UDP в режиме кластера — демонстрация запуска нескольких рабочих процессов,
 *        разрешения имени хоста через DNS-резолвер и обработки датаграмм каждым воркером
 *
